...
static const int64 nTargetTimespan = 60 * 60;						// NetCoin: every 60 minutes
static const int64 nTargetSpacing = 60;								// NetCoin: 60 sec
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // NetCoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
